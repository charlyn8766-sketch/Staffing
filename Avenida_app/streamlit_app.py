...
# ------------------ Defaults ------------------
DEFAULT_STAFF = [
    {"name":"Cristina_Mata",    "min_week_hours":25},
    {"name":"Gabriela_Velasco", "min_week_hours":20},
    {"name":"Javi",             "min_week_hours":27.5},
    {"name":"Lorena",           "min_week_hours":25},
    {"name":"Aurora",           "min_week_hours":25},
    {"name":"Clara_Nogales",    "min_week_hours":25},
]
