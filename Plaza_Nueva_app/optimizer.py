...
def solve_schedule(
    ...
    """
    Plaza Nueva variant (same as Avenida/Naranjos):
    - 13 slots per day (12:00..24:00)
    - 12h rest: only t=13 vs next day t=1
    ...
    model = pulp.LpProblem("Shift_Scheduling_PlazaNueva", pulp.LpMinimize)
